...
RUNTIME_VERSION = '11'
IMPORTS = ('@drools_tests/snowpark-java-drools-0.0.1-FAT.jar')
HANDLER = 'org.example.udft.ProductPOVUDTFHandler'
PACKAGES = ('com.snowflake:snowpark:latest');

 

SELECT top 10 E.CustomerType as PRODUCT_POV , D.CustomerType, C.* FROM CUSTOMER_OFFERINGS C, 
TABLE(PRODUCT_POV(
